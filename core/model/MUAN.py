...
d/h = 96
d_g = 96
# python run.py --RUN="train" --GPU="2" --BACKBONE="MUAN" --LAYER=8 --VERSION="MUAN-8-test0" --NW=16 --HIDDEN_SIZE=768 --LR_BASE=0.0002 --SPLIT="train"
"""
...
class MUAN(nn.Module):

    def __init__(self, __C):
        super(MUAN, self).__init__()
